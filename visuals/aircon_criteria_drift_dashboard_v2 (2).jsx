...
const C = {
  ...
  airconGap:  { bg: "#4A2A04", border: "#EF9F27", title: "#FAC775", body: "#EF9F27" },
  airconGood: { bg: "#073D31", border: "#4DB896", title: "#9FE1CB", body: "#5DCAA5" },
  airconBad:  { bg: "#5A1510", border: "#F09B7B", title: "#F5C4B3", body: "#F09B7B" },
...
const layers = [
  {
    ...
    aircon: { title: "Confirmed strength",    body: ["Chris confirmed audit trail", "for all agent actions exists"],  theme: "airconGood" },
  ...
  },
  {
    ...
    aircon: { title: "Not evidenced publicly", body: ["Gap confirmed by Chris:", "criteria drift unaddressed"],      theme: "airconGap" },
  ...
  },
  {
    ...
    aircon: { title: "Not evidenced publicly",  body: ["Red Sea, tariff shifts, carrier", "changes — no flag seen"], theme: "airconGap" },
  ...
  },
  {
    ...
    aircon: { title: "Not evidenced publicly",  body: ["Air freight BVC is critical —", "signals change daily"],     theme: "airconGap" },
  ...
  },
  {
    ...
    aircom: { title: "Est. 30 – 90 days",       body: ["Confident but miscalibrated", "quotes for up to 3 months"], theme: "airconBad" },

...
const layers = [
  {
    ...
    detail: "Action audit is the one layer where Aircom matches the benchmarks. Chris explicitly confirmed an audit trail for agent actions exists. This is the foundation — but it answers only half the question.",
  },
  {
  ...
  },
  {
    ...
    detail: "When a macro event changes the operating environment, Amazon and Airbus have explicit mechanisms that force a criteria review. Aircom has no publicly evidenced equivalent. This is Diagnostic Question 1.",
  },
  {
  ...
  },
  {
    ...
    detail: "The Silent Distortion Window is the period during which a system produces confidently wrong outputs with no internal signal anything has changed. For Aircom, without drift detection, this window is estimated at 30–90 days in current air freight conditions.",
  },
];
...
const scores = [
  ...
  { org: "Aircom",  score: "CES: 42",  sub: "Mandatory recalibration flag",  theme: "neutral" },
];
...
const sprintScope = [
  ...
  { week: "Week 2", title: "Benchmark Mapping", items: ["Map Aircom architecture against Amazon/Airbus five-layer framework", "Score each layer against CES methodology", "Identify confirmed gaps vs. public-data hypothesis gaps"] },
    ...
    <div style={{ fontFamily: "'IBM Plex Mono', monospace" }}>
      <div style={{ marginBottom: 24 }}>
        <p style={{ fontSize: 13, color: "#C2C0B6", lineHeight: 1.8, margin: "0 0 20px" }}>
          At CES 42, an estimated <strong style={{ color: "#EF9F27" }}>18% of quotes</strong> carry miscalibrated criteria. Enter Aircom's operating parameters to model the revenue exposure from a confirmed Silent Distortion Window.
        </p>
...
function ProveMeWrong() {
  ...
  return (
    <div>
      <p style={{ fontSize: 13, color: "#C2C0B6", lineHeight: 1.8, margin: "0 0 20px" }}>
        The Aircom CES hypothesis is built entirely from public data. Below are the five specific data points that would move the score. This is not a sales document. It is an invitation to prove the analysis wrong — and a precise description of what that proof requires.
      </p>
      ...
      <div style={{ background: "linear-gradient(135deg, #0D1F1A 0%, #111114 50%, #1A0D1A 100%)", borderBottom: "1px solid rgba(222,220,209,0.08)", padding: "32px 32px 28px" }}>
        <div style={{ maxWidth: 900 }}>
          ...
          <p style={{ margin: "0 0 20px", fontSize: 14, color: "#888780", lineHeight: 1.6 }}>
            A structured public-data intelligence package benchmarking AI decision criteria drift architecture across Amazon, Airbus, and Aircom — prepared for executive diagnostic conversation with Chris Condon, CEO.
          </p>
        ...
        {activeTab === "benchmark" && (
          <div>
            <div style={{ display: "grid", gridTemplateColumns: "180px 1fr 1fr 1fr", gap: 8, marginBottom: 8 }}>
              <div />
              {["Amazon", "Airbus", "Aircom (hypothesis)"].map(h => (
        ...
        {activeTab === "revenue" && (
          <div style={{ maxWidth: 760 }}>
            <div style={{ marginBottom: 24 }}>
              ...
              <p style={{ fontSize: 12, color: "#555452", margin: 0 }}>Hypothesis-grade model · McDonald (2026) · Update inputs with confirmed Aircom operating data</p>
            </div>
            <RevenueEstimator />
          </div>
        )}
